...
LRESULT URLCtrl::runProc(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_NCDESTROY:
		...
		break;
	// Paint the static control using our custom colours, and with an underline text style
	case WM_PAINT:
		{
	...
	case WM_KEYUP:
		...
		break;
	// A standard static control returns HTTRANSPARENT here, which prevents us
	// from receiving any mouse messages. So, return HTCLIENT instead.
	case WM_NCHITTEST:
		return HTCLIENT;
	}
